...
test_that("datasets have the required variables", {
  pointblank::expect_col_exists(agreements[["LABPTA"]], vars(Title))
  pointblank::expect_col_exists(agreements[["LABPTA"]], vars(Beg))
  expect_true(any(grepl("ID$", colnames(agreements[["LABPTA"]]))))
  pointblank::expect_col_exists(agreements[["LABPTA"]], vars(Signature))
})
