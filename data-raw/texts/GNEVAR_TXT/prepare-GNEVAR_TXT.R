...
# To avoid overlaps in texts stored, GNEVAR_TXT is based on a consolidated 
...
GNEVAR_TXT <- manydata::favour(manytrade::agreements, c("GPTAD", "TOTA")) %>% 
...
# Add treaty texts into GNEVAR_TXT
GNEVAR_TXT <- dplyr::left_join(GNEVAR_TXT, GPTAD_TXT,
                               by = c("manyID", "Title"))
...
REM_TXT <- readxl::read_excel("data-raw/texts/GNEVAR_TXT/REM_TXT.xlsx")
...
GNEVAR_TXT <- dplyr::left_join(GNEVAR_TXT, REM_TXT,
                               by = "manyID")
...
manypkgs::export_data(GNEVAR_TXT, database = "texts",
