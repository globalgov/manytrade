...
```
    ...
    ##   <chr>   <chr>                                                    <chr> <chr>  
    ## 1 DESTA   A. Dür, L. Baccini, and M. Elsig. “The Design of Intern… http… from -…
    ## 2 GPTAD   W. B. Group. Global Preferential Trade Agreement Databa… http… from -…
    ## 3 LABPTA  D. Raess, A. Dür, and D. Sari. “Protecting labor rights… http… from -…
    ## 4 TOTA    W. Alschner, J. Seiermann, and D. Skougarevskiy. Text-a… http… from -…
    ## 5 TREND   J. Morin, A. Dür, and L. Lechner. “Mapping the trade an… http… from -…
    ## 6 HUGGO   Hand-coded data by the GGO team                          Hand… J. - H…
    ## 7 AIGGO   Machine-generated data by the GGO team Mapping           Mach… J. - H…
