...
![GitHub release (latest by date)](https://img.shields.io/github/v/release/globalgov/qTrade)
![GitHub Release Date](https://img.shields.io/github/release-date/globalgov/qTrade)
<!-- badges: end -->

qTrade is a data package in the [qData](https://github.com/globalgov/qData) ecosystem of qPackages.
...
Once you have installed the package, you can see the different databases and datasets included in the {qTrade} package using the following function.
...
analysis. Just take a look at our vignettes [here](https://globalgov.github.io/qData/articles/user.html).
