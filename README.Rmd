...
```{r datasets, eval=FALSE, warning=FALSE, message=FALSE}
...
The 'many packages' universe endeavours to be as transparent as possible about where data 
...
this package, but could be useful within the wider 'many packages' universe,
[manypkgs](https://github.com/globalgov/manypkgs) includes a number of
functions that make it easy to create a new 'many package' and 
