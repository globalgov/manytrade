...
manytrade is a data package in the [many packages](https://github.com/globalgov/manydata) universe.
...
Please also check out [`{manydata}`](https://github.com/globalgov) for more about the other packages in the many packages universe. 
...
and then you can discover, install and update various many packages universe from the console.
...
The [many packages](https://github.com/globalgov/manydata) universe is aimed at collecting, connecting and correcting network data across issue-domains of global governance. 

While the packages in the `many packages` universe can and do include novel data, 
...
functions that make it easy to create a new package in the `many packages` universe
and populate it with clean, consistent global governance data.

If you have any other ideas about how this package or the `many packages` universe more broadly
